        ...
        <footer className="bg-gray-800 text-white py-8">
            <div className="container mx-auto flex flex-wrap justify-between">
                <div className="w-full md:w-1/3 lg:w-1/4 px-4 mb-8">
                    ...
                    <p className="mt-4">aprovechamiento@gmail.com <br />
                        Dir: Cra 5 34-21 centro <br />
                        Tel: +57 300 811 0177 <br />
                        Tel: +57 313 617 8538 <br />
                        powered by <br />
                        Jhocer Sanchez <br />
                        Maicol Galarcio <br />
                        jhocersanchez99@gmail.com <br />
                        maicolgalarcio@gmail.com <br />
                ...
                <div className="w-full md:w-1/3 lg:w-1/4 px-4 mb-8">
                    ...
                    <div className="mt-4 flex space-x-4">
                        ...
                        <Link href="https://www.WhatsAppweb.com" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
